...
returns table(id uuid,device_code text) language sql security definer set search_path=public as $$
  select d.id,d.device_code from public.devices d where d.device_code=p_device_code and d.secret_hash=crypt(p_secret,d.secret_hash) limit 1;
$$;
